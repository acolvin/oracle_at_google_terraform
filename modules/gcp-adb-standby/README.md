...
This module expects that the database is configured for private endpoint connecivity through ODB networks.  You can create an ODB network with the [gcp-odb-network](modules/gcp-odb-network) module.
